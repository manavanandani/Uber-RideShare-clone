...
const resultsPath = path.join(__dirname, 'performance_results.json');
const performanceData = JSON.parse(fs.readFileSync(resultsPath, 'utf8'));

// Generate an HTML file with chart.js to visualize the results
const html = `
<!DOCTYPE html>
<html lang="en">
<head>
