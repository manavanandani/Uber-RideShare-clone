// src/components/common/LeafletMap.jsx
...
function LeafletMap({
  ...
  useEffect(() => {
    ...
    // Update map when component unmounts
    return () => {
      if (mapInstanceRef.current) {
  ...
  useEffect(() => {
    ...
    // Note: For actual routing (instead of a straight line), you would need to
    // use a routing API like OSRM or GraphHopper with OpenStreetMap data
